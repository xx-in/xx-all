...
export function Title(props: IProps<IDialogTitleProps>) {
  ...
  return (
    <div class="flex h-10 shrink-0 grow-0 items-center justify-between rounded-sm border-b border-b-stone-200 px-2 pt-1 dark:bg-stone-800 dark:text-white">
      <div class="flex-1">{children.get()}</div>
      <Flex class="size-5 justify-center hover:bg-stone-200 dark:hover:bg-stone-700">
        <Svg.Close
